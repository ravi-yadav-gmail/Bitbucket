...
class User extends BaseUser implements UserInterface, \Serializable
{
     ...
     * @ORM\OneToOne(targetEntity="UserBundle\Entity\Client", mappedBy="user", fetch="EAGER")
     */
    protected $oauthClient;

    /**
     * One User has many Access Tokens;
     * @ORM\OneToMany(targetEntity="UserBundle\Entity\AccessToken", mappedBy="user", fetch="EAGER")
     */
    protected $accessToken;

    /**
     * One User has many Auth Codes;
     * @ORM\OneToMany(targetEntity="UserBundle\Entity\AuthCode", mappedBy="user", fetch="EAGER")
     */
    protected $authCode;

    /**
    * One User has many Refresh Tokens;
    * @ORM\OneToMany(targetEntity="UserBundle\Entity\RefreshToken", mappedBy="user", fetch="EAGER")
    */
